        ...
        <div className="flex flex-col md:flex-row gap-2">
          ...
          <div className="flex gap-2">
            <a
              ...
              href={`https://www.facebook.com/sharer/sharer.php?u=${process.env.NEXT_PUBLIC_SITE_URL || "http://localhost:3000"}/blog/${slug?.current}`}
              target="_blank"
            ...
            <a
              className="hover:opacity-70"
              href={`mailto:?subject=${title}&body=${title}%0A%0A${process.env.NEXT_PUBLIC_SITE_URL || "http://localhost:3000"}/blog/${slug?.current}`}
              target="_blank"
              rel="noopener noreferrer"
